...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get("MEASUREMENTS_DB", "tokens_db"),
        'USER': os.environ.get("MEASUREMENTS_DB_USER", "tokens_user"),
...
PATH_VAR = "http://" + os.environ.get("VARIABLES_HOST", "0.0.0.0") + ":" + os.environ.get("VARIABLES_PORT", "8080") + "/dtokencreate/"